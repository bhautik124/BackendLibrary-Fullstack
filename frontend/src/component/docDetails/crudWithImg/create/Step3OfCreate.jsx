...
import Step4OfCreate from "./Step4OfCreate";
...
const Step3OfCreate = () => {
  ...
  const SawApi = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck("crud-with-image-create-model");
  ...
  return (
    <div>
      <div className="mb-3 mt-8">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-zinc-100 text-xl sm:text-2xl font-semibold">
            STEP 3 – Add Data to the Selected Model
          </h2>
        </div>
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-base sm:text-lg">
                ...
                <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
                  CRUD Create with Images
                </code>{" "}
                API endpoint to add data to the selected model.
              </p>
            </div>
            <button
              onClick={SawApi}
      ...
      <PaymentModal
        ...
        title="Payment Required - CRUD Create with Images API"
      />
