...
import DeleteWholeModelStep3 from "./DeleteWholeModelStep3";
...
const DeleteWholeModelStep2 = () => {
  ...
  const SawApi = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck("crud-with-image-whole-modeldelete");
  ...
  return (
    <div>
      <div className="mb-3 mt-8">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-zinc-100 text-xl sm:text-2xl font-semibold">
            STEP 2 – Delete Collection as Needed
          </h2>
        </div>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-base sm:text-lg">
              ...
              <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
                CRUD Delete Whole Model with Images
              </code>{" "}
              API endpoint to delete an entire collection.
            </p>
          </div>
      ...
      <PaymentModal
        ...
        title="Payment Required - CRUD Delete Whole Model with Images API"
      />
      
      <DeleteWholeModelStep3 />
    </div>
  );
};

export default DeleteWholeModelStep2;
