...
import CodeVersion1 from "./fullCode/FullCodeOfFetchModel";
import CodeVersion2 from "./fullCode/FullCodeOfAllAPI";
...
const DeleteWholeModelStep4 = () => {
  ...
  const codeLabels = ["Fetch Model & Field", "Fetch Model & Delete Model"];
