const FullCodeOfDeleteModel = `import React, { useEffect, useState } from "react";
...
export default function ModelsWithModelDelete() {
  ...
  const handleDeleteModel = async (modelName) => {
    try {
      ...
      alert(\`Deletion of model '\${modelName}' failed\`);
    }
  };
            ...
            >
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-red-500 to-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-red-600 hover:to-red-700 transition-all duration-200"
                >
                  Delete Model
                </button>
              </div>
...
export default FullCodeOfDeleteModel;
