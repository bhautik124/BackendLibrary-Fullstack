...
import DeleteFieldStep2 from "./DeleteFieldStep2";
  ...
  return (
    <div className="pb-40 px-4 sm:px-6 lg:px-8">
      <h1 className="text-zinc-100 text-2xl sm:text-4xl font-bold">
        CRUD Delete Field Process – (2 Steps)
      </h1>
      ...
      <div className="mt-5">
        ...
        <div className="ml-2 sm:ml-10">
          <h3 className="text-md sm:text-md font-semibold mb-2">
            This API helps you delete any field from a collection, such as{" "}
        ...
        <div className="mb-3 mt-5 sm:ml-10">
          <div className="flex items-start gap-3 mb-4">
            ...
            <p className="text-base sm:text-lg">
              ...
              API, then delete the desired field.
            </p>
          </div>
        </div>
...
export default WithImgDeleteFieldStep1;
