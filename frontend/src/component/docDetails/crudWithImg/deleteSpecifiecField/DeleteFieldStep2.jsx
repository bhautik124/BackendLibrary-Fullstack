...
import DeleteFieldStep3 from "./DeleteFieldStep3";
...
const DeleteFieldStep2 = () => {
  ...
  const SawApi = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck("crud-with-image-delete");
  ...
  return (
    <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="text-base sm:text-lg">
              ...
              <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
                CRUD Delete Field with Images
              </code>{" "}
              API endpoint to delete a field from the selected model.
            </p>
          </div>
      ...
      <PaymentModal
        ...
        title="Payment Required - CRUD Delete Field with Images API"
      />
...
export default DeleteFieldStep2;
