...
// Dummy 4 code versions — replace with your actual codes
import CodeVersion1 from "../deleteSpecifiecField/howToCallAxios/step-1/CallAxios";
import CodeVersion2 from "../deleteSpecifiecField/howToCallAxios/step-2/CallAxios";
import CodeVersion3 from "../deleteSpecifiecField/howToCallAxios/step-3/CallAxios";
import DeleteFieldStep4 from "./DeleteFieldStep4";

const DeleteFieldStep3 = () => {
  const [showModal, setShowModal] = useState(false);
  const [whichCodeSaw, setWhichCodeSaw] = useState(null);
  const [showFullCode, setShowFullCode] = useState(false);
  const [copied, setCopied] = useState(false);

  const codeBlocks = [CodeVersion1, CodeVersion2, CodeVersion3];
  const codeLabels = [
    "Fetch all Model & Field",
    "Delete the data of selected field",
    "Single Axios Call Covering All Two APIs",
  ];
...
export default DeleteFieldStep3;
