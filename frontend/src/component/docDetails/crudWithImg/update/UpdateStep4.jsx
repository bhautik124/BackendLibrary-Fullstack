...
import CodeVersion1 from "../update/fullCode/FullCodeOfFetchModel";
import CodeVersion2 from "../update/fullCode/FullCodeOfAllAPI";
...
const UpdateStep4 = () => {
  ...
  const codeLabels = ["Fetch Model & Field", "Fetch Model & Update data"];
