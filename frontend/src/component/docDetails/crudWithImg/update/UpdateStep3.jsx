...
import CodeVersion1 from "../update/howToCallAxios/step-1/CallAxios";
import CodeVersion2 from "../update/howToCallAxios/step-2/CallAxios";
import CodeVersion3 from "../update/howToCallAxios/step-3/CallAxios";
...
const UpdateStep3 = () => {
  ...
  const codeLabels = [
    ...
    "Update the data of selected model",
