      ...
      <div className="mt-5">
        ...
        <div className="ml-2 sm:ml-10">
          <h3 className="text-md sm:text-md font-semibold mb-2">
            This API helps you update collection details, such as{" "}
      ...
      <div className="mt-8">
        ...
        <div className="mb-3 mt-5 sm:ml-10">
          <div className="flex items-start gap-3 mb-4">
            ...
            <p className="text-base sm:text-lg">
              Generate a token and API key for authentication to perform
              updates.
            </p>
          </div>
        </div>
...
export default WithImgUpdateStep1;
