...
// import ForApiGenereateCheckAuth from "../../../userLoginPage/protectedRoute/ForApiGenereateCheckAuth";
// import { Navigate } from "react-router-dom";

// const BeginnerRegister = () => {
//   const isAuthCheck = ForApiGenereateCheckAuth();
//   if (isAuthCheck === true) {
...
//             This API allows you to register a new user by sending their details{" "}
...
//               password
//             </code>{" "}
//             to the backend. It handles everything — validation, hashing, token
//             generation — and returns a secure HTTP-only cookie. You don't need
//             to write any backend code.
//           </h3>
//         </div>
//       </div>
...
//             <li>
//               {" "}
//               The token is sent in an HTTP-only cookie. You won't be able to
...
//             </li>
//             <li>
//               Use try/catch or .catch to handle validation errors (e.g., weak
...
// export default BeginnerRegister;
...
const BeginnerRegister = () => {
  ...
  const handleSaw = async () => {
    ...
    try {
      // Use PaymentService to handle payment checks
      const result = await PaymentService.generateAPIWithPaymentCheck(["register"]);
      
      if (result.requiresPayment) {
        // Show payment modal instead of error
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-6xl max-h-[85vh] overflow-y-auto bg-gradient-to-br from-zinc-900 to-zinc-800 border border-stone-700 rounded-xl p-6 shadow-2xl">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-zinc-100 text-xl font-bold mb-1">Beginner Registration Complete Code</h3>
                <span className="text-zinc-400 text-sm">React + Tailwind CSS + Axios + User Registration</span>
              </div>
              <div className="flex items-center gap-4">
                <FaCopy
                  onClick={handleCopyFullCode}
            ...
            <div className="mb-6">
              <h4 className="text-zinc-200 font-semibold mb-3">Choose your registration UI design:</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Futuristic Glass</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Magical Portal</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Nature Inspired</div>
                </button>
              </div>
            </div>
