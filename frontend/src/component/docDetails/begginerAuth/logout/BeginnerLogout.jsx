...
//             This API logs out the current user by clearing the authentication
//             cookie from the browser. You don't need to pass any data — just call
//             this API and the user will be logged out.
//           </h3>
//         </div>
//       </div>
...
const BeginnerLogout = () => {
  ...
  const handleSaw = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck(["logout"]);
