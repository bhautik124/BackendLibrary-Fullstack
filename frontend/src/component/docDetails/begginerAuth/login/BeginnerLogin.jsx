...
const BeginnerLogin = () => {
  ...
  const handleSaw = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck(["login"]);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-6xl max-h-[85vh] overflow-y-auto bg-gradient-to-br from-zinc-900 to-zinc-800 border border-stone-700 rounded-xl p-6 shadow-2xl">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-zinc-100 text-xl font-bold mb-1">Beginner Login Complete Code</h3>
                <span className="text-zinc-400 text-sm">React + Tailwind CSS + Axios + User Authentication</span>
              </div>
              <div className="flex items-center gap-4">
                <FaCopy
                  onClick={handleCopyFullCode}
