...
// import HowToUseCodePart1 from "./howToUseCodeSectionPart1/HowToUsePart1";
// import HowToUseCodePart2 from "./howToUseCodeSectionPart2/HowToUsePart2";
...
//   //*********************************
//   // how to use code section part-1
//   const [copied1, setCopied1] = useState(false);

//   const handleCopyPurposeCode1 = () => {
//     navigator.clipboard.writeText(HowToUseCodePart1);
//     setCopied1(true);
...
//   //*********************************
//   // how to use code section part-2
//   const [copied2, setCopied2] = useState(false);

//   const handleCopyPurposeCode2 = () => {
//     navigator.clipboard.writeText(HowToUseCodePart2);
//     setCopied2(true);
...
//             This API handles user registration via{" "}
//             <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
//               Google Sign-In
//             </code>{" "}
//             . Upon a user's first login with Google, it extracts their verified
//             name and email from the Google ID token, then creates a new user
...
//           <h2 className="text-xl sm:text-2xl font-bold text-zinc-100">
//             Set Up Google OAuth Client ID and Authorized Origins
//           </h2>
//         </div>

//         <div className="ml-2 sm:ml-10">
//           <h3 className="text-md font-semibold mb-2">
//             Before getting started, ensure you’ve generated your Client ID token
//             and added your URI under Authorized JavaScript Origins.
//           </h3>
...
//         {/* step-1 */}
//         <div>
//           <div className="flex items-center gap-2 mt-7 ml-3 mb-3">
//             <LuStepForward className="text-zinc-100 text-md sm:text-xl" />
//             <h3 className="text-md sm:text-lg font-semibold text-zinc-100">
//               Step 1: Wrap your{" "}
//               <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
//                 main.jsx
//               </code>{" "}
...
//             <button
//               onClick={handleCopyPurposeCode1}
...
//             <LuStepForward className="text-zinc-100 text-md sm:text-xl" />
//             <h3 className="text-md sm:text-lg font-semibold text-zinc-100">
//               Step 2: Call your generated API using Axios
//             </h3>
//           </div>
//         </div>
//         <div className="relative inline-block w-full bg-black border border-stone-700 rounded-md p-3 sm:p-5 text-xs sm:text-sm font-mono text-gray-300">
...
//             <li>
//               {" "}
//               Google Sign-In is done using the @react-oauth/google package.
//             </li>
//             <li>
//               After login, we get a Google token (JWT) which contains user info.
//             </li>
//           </ul>
//         </div>
//       </div>
//       <CopyToast show={copied1} />
...
const SignUp = () => {
  ...
  const handleSaw = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck(["google-auth"]);
    ...
    <div className="pb-40 px-4 sm:px-6 lg:px-8">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-6xl max-h-[85vh] overflow-y-auto bg-gradient-to-br from-zinc-900 to-zinc-800 border border-stone-700 rounded-xl p-6 shadow-2xl">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-zinc-100 text-xl font-bold mb-1">Google OAuth Complete Code</h3>
                <span className="text-zinc-400 text-sm">React + Tailwind CSS + @react-oauth/google</span>
              </div>
              <div className="flex items-center gap-4">
                <FaCopy
                  onClick={handleCopyFullCode}
            ...
            <div className="mb-6">
              <h4 className="text-zinc-200 font-semibold mb-3">Choose your UI style:</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Clean & Simple</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Futuristic Tech</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Elegant Magic</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Nature Theme</div>
                </button>
              </div>
            </div>
            ...
            <div className="mb-4 border border-stone-700 rounded-md px-4 py-2 text-sm text-zinc-100 bg-zinc-800">
              npm install @react-oauth/google axios react-icons
            </div>
      ...
      <div className="mt-8 sm:mt-10">
        ...
        <div className="ml-2 sm:ml-10">
          <ul className="list-disc list-inside space-y-1 text-sm sm:text-base">
            <li>
              Google Sign-In is done using the{" "}
              <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
                @react-oauth/google
              </code>{" "}
              package.
            ...
            <li>
              After login, a Google token (JWT) is received, which contains user
              info.
            </li>
            <li>
              Use{" "}
            ...
            <li>
              Use try/catch or .catch to handle errors (e.g., invalid Google
              token, network issues).
            </li>
          </ul>
        </div>
      </div>
