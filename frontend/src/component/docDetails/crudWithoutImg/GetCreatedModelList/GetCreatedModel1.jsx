  ...
  const generateAllData = async () => {
    ...
    try {
      const response = await dispatch(
        fetchDataWithoutImg({ feature: "crud-get-all-models-with-data" })
      );
      if (
        !response.api?.[0]?.url ||
      ...
      <div className="mt-5">
        ...
        <div className="ml-2 sm:ml-10">
          <h3 className="text-md sm:text-md font-semibold mb-2">
            This API enables the retrieval of all created models along with
        ...
        <div className="mb-3 mt-5 sm:ml-10">
          <div className="flex items-start gap-3 mb-4">
            ...
            <p className="text-base sm:text-lg">
              ...
              API to fetch all collections and their data.
            </p>
          </div>
        </div>
...
export default GetCreatedModel1;
