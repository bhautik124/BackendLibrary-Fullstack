...
// Single code import
import CodeVersion1 from "../GetCreatedModelList/fullCode/FullCodeOfFetchModel";

const GetCreatedModel3 = () => {
  ...
  const installCommands = ["npm install axios react-icons"];
...
export default GetCreatedModel3;
