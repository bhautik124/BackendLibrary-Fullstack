...
const DeleteWholeModelStep2 = () => {
  ...
  const SawApi = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck("crud-delete-wholemodel");
  ...
  return (
    <div>
      <div className="mb-3 mt-8">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-zinc-100 text-xl sm:text-2xl font-semibold">
            STEP 2 – Delete the Selected Collection
          </h2>
        </div>
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-base sm:text-lg">
                ...
                <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
                  CRUD Delete Whole Model
                </code>{" "}
                API endpoint to delete the collection.
              </p>
            </div>
            <button
              onClick={SawApi}
      ...
      <PaymentModal
        ...
        title="Payment Required - CRUD Delete Whole Model API"
      />
