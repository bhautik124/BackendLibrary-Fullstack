...
import CodeVersion1 from "../deleteWholeModel/howToCallAxios/step-1/CallAxios";
import CodeVersion2 from "../deleteWholeModel/howToCallAxios/step-2/CallAxios";
import CodeVersion3 from "../deleteWholeModel/howToCallAxios/step-3/CallAxios";
import DeleteWholeModelStep4 from "./DeleteWholeModelStep4";

const DeleteWholeModelStep3 = () => {
  ...
  return (
    <div className="pb-40">
      ...
      <DeleteWholeModelStep4 />
    </div>
  );
};

export default DeleteWholeModelStep3;
