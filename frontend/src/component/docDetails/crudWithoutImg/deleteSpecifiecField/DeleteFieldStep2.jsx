...
const DeleteFieldStep2 = () => {
  ...
  const SawApi = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck("crud-delete");
  ...
  return (
    <div>
      <div className="mb-3 mt-8">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-zinc-100 text-xl sm:text-2xl font-semibold">
            STEP 2 – Delete Fields in the Selected Model
          </h2>
        </div>
      </div>
      ...
      <PaymentModal
        ...
        title="Payment Required - CRUD Delete API"
      />
