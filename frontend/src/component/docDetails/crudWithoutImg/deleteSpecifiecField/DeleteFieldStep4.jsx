...
import CodeVersion1 from "../deleteSpecifiecField/fullCode/FullCodeOfFetchModel";
import CodeVersion2 from "../deleteSpecifiecField/fullCode/FullCodeOfAllAPI";

const DeleteFieldStep4 = () => {
  ...
  const codeLabels = ["Fetch Model & Field", "Fetch Model & Delete data"];
...
export default DeleteFieldStep4;
