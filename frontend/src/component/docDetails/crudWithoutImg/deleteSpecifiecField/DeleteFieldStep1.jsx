      ...
      <div className="mt-5">
        ...
        <div className="ml-2 sm:ml-10">
          <h3 className="text-md sm:text-md font-semibold mb-2">
            ...
            specific collection and delete fields from it.
          </h3>
        </div>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="mb-3 mt-5 sm:ml-10">
          <div className="flex items-start gap-3 mb-4">
            ...
            <p className="text-base sm:text-lg">
              Generate a token and API key to perform delete operations.
            </p>
          </div>
        </div>
      </div>
...
export default DeleteFieldStep1;
