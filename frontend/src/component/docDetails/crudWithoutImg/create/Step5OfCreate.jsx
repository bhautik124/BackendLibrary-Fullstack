...
import CodeVersion1 from "./fullCode/JsonForemetInclude";
import CodeVersion2 from "./fullCode/JsonFormetNotInclude";
...
const Step5OfCreate = () => {
  ...
  const installCommands = [
    `npm install axios react-icons @codemirror/view@6.38.1 @codemirror/state@6.5.2 @codemirror/lang-json@6.0.2 @codemirror/autocomplete@6.18.6 @codemirror/commands@6.8.1 @codemirror/basic-setup@0.20.0`,
    "npm install axios react-icons",
  ];

  const codeLabels = [
    "Fetch Model & JSON data insertion (Auto-close brackets)",
    "Fetch Model & JSON data insertion (Manual brackets)",
  ];
