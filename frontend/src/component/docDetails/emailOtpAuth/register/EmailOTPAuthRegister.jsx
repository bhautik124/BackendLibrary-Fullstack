...
//             This API is used to register a new user (email + password) in the
//             system. It stores the data and sends back a token in a secure
//             cookie.{" "}
//             <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
//               No OTP is involved in register
//             </code>{" "}
//             .
//           </h3>
//         </div>
...
//             <li>
//               {" "}
//               On success, a secure HTTP-only cookie is set automatically.
//             </li>
//             <li>
//               Always use{" "}
//               <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
...
//               </code>{" "}
//               in frontend while calling the API.
//             </li>
//             <li>API returns token + user info in response</li>
//           </ul>
//         </div>
//       </div>
...
// export default EmailOTPAuthRegister;
...
const EmailOTPAuthRegister = () => {
  ...
  const handleSaw = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck(["email-otp-register"]);
  ...
  return (
    <div className="pb-40 px-4 sm:px-6 lg:px-8">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-6xl max-h-[85vh] overflow-y-auto bg-gradient-to-br from-zinc-900 to-zinc-800 border border-stone-700 rounded-xl p-6 shadow-2xl">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-zinc-100 text-xl font-bold mb-1">Email OTP Registration Complete Code</h3>
                <span className="text-zinc-400 text-sm">React + Tailwind CSS + Axios + OTP Authentication</span>
              </div>
              <div className="flex items-center gap-4">
                <FaCopy
                  onClick={handleCopyFullCode}
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                >
                  ...
                  <div className="text-xs opacity-75">OTP Verification</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Magic Verification</div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Nature Community</div>
                </button>
              </div>
            </div>
      ...
      <div className="mt-8 sm:mt-10">
        ...
        <div className="ml-2 sm:ml-10">
          <ul className="list-disc list-inside space-y-1 text-sm sm:text-base">
            <li>On success, a secure HTTP-only cookie is set automatically.</li>
            <li>
              Always use{" "}
              <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
                withCredentials: true
