...
//             This API allows you to register a new user by sending details like
//             name, email, and role. It also enables{" "}
...
//             <li>
//               Registration is done by sending{" "}
//               <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
//                 userName
//               </code>{" "}
//               ,{" "}
...
//               to the backend.
//             </li>
//             <li>Backend validates data using Joi schema.</li>
//             <li className="mt-2">
//               Always use:{" "}
//               <code className="bg-stone-800 text-zinc-200 px-2 py-1 rounded text-xs sm:text-sm font-mono">
...
//             </li>
//             <li>
//               A JWT token is generated and sent back in a secure httpOnly
//               cookie.
//             </li>
//           </ul>
//         </div>
...
// export default RoleBaseRegister;
...
const RoleBaseRegister = () => {
  ...
  const handleSaw = async () => {
    ...
    try {
      const result = await PaymentService.generateAPIWithPaymentCheck(["role-based-register"]);
      ...
      <div className="mt-8 sm:mt-10">
        ...
        <div className="ml-2 sm:ml-10">
          <h3 className="text-md sm:text-md font-semibold mb-2">
            ...
            and sets a secure HTTP-only cookie with a JWT token upon successful
            registration.
          </h3>
        </div>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-6xl max-h-[85vh] overflow-y-auto bg-gradient-to-br from-zinc-900 to-zinc-800 border border-stone-700 rounded-xl p-6 shadow-2xl">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-zinc-100 text-xl font-bold mb-1">Role-Based Registration Complete Code</h3>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                >
                  ...
                  <div className="text-xs opacity-75">Elegant Luxury</div>
                </button>
                <button
      ...
      <div className="mt-8 sm:mt-10">
        ...
        <div className="ml-2 sm:ml-10">
          <ul className="list-disc list-inside space-y-1 text-sm sm:text-base">
            ...
            <li>
              A JWT token is generated and sent back in a secure HTTP-only
              cookie upon successful registration.
            </li>
            <li>
              Use try/catch or .catch to handle errors (e.g., invalid data,
              duplicate email, network issues).
            </li>
          </ul>
        </div>
      </div>
