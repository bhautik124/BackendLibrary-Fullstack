...
import { FaEye, FaEyeSlash, FaLeaf, FaTree, FaSeedling } from "react-icons/fa";
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-green-900 via-emerald-900 to-teal-900 px-4">
      ...
      <div className="relative z-10 backdrop-blur-lg bg-emerald-800/20 border border-emerald-400/30 rounded-3xl p-8 shadow-2xl max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-emerald-300 text-sm">Grow with our sustainable digital forest</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="relative group">
            <input
              type="email"
              name="email"
              placeholder="Your Digital Garden Address"
          ...
          >
            {loading ? (
              <div className="flex items-center justify-center gap-2">
                ...
                <span>Planting Your Digital Seed...</span>
              </div>
            ) : (
              <span>Join the Eco Community</span>
            )}
        ...
        <div className="text-center text-xs text-emerald-200 mt-6 space-y-2">
          ...
          <p className="text-emerald-300">Your registration helps plant a virtual tree in our digital forest</p>
        </div>
